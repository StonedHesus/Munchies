...
([(function(module,exports,__webpack_require__){module.exports=__webpack_require__(1);}),(function(module,exports,__webpack_require__){'use strict';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _fuse=__webpack_require__(2);var _fuse2=_interopRequireDefault(_fuse);var _classnames=__webpack_require__(3);var _classnames2=_interopRequireDefault(_classnames);var _index=__webpack_require__(4);var _index2=_interopRequireDefault(_index);var _index3=__webpack_require__(31);var _utils=__webpack_require__(32);__webpack_require__(33);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
    ...
    module.exports = function () {
        function Choices() {
            ...
            this.isIe11 = !!(navigator.appVersion.match(/Trident/) && navigator.appVersion.match(/rv[ :]11/));
        ...
        _createClass(Choices, [{
            ...
            key: 'renderChoices', value: function renderChoices(choices, fragment) {
                ...
                var _config = this.config, renderSelectedChoices = _config.renderSelectedChoices,
                    searchResultLimit = _config.searchResultLimit, renderChoiceLimit = _config.renderChoiceLimit;
            ...
            key: 'highlightAll', value: function highlightAll() {
                var _this4 = this;
            ...
            key: 'unhighlightAll', value: function unhighlightAll() {
                var _this5 = this;
                var items = this.store.getItems();
                items.forEach(function (item) {
            ...
            key: 'removeActiveItems', value: function removeActiveItems(excludedId) {
                var _this7 = this;
                var items = this.store.getItemsFilteredByActive();
                items.forEach(function (item) {
            ...
            key: 'removeHighlightedItems', value: function removeHighlightedItems() {
                var _this8 = this;
            ...
            key: 'clearStore', value: function clearStore() {
            ...
            key: '_selectPlaceholderChoice', value: function _selectPlaceholderChoice() {
            ...
            key: '_handleChoiceAction', value: function _handleChoiceAction(activeItems, element) {
                ...
                (0, _utils.triggerEvent)(this.passedElement, 'choice', {choice: choice});
            ...
            key: '_handleLoadingState', value: function _handleLoadingState() {
            ...
            key: '_setInputWidth', value: function _setInputWidth() {
                if (this.placeholder) {
            ...
            key: '_onKeyDown', value: function _onKeyDown(e) {
                var _this16 = this, _keyDownActions;
            ...
            key: '_onTouchMove', value: function _onTouchMove() {
                if (this.wasTap === true) {
                    this.wasTap = false;
                }
            }
            ...
            key: '_onMouseOver', value: function _onMouseOver(e) {
                if (e.target === this.dropdown || this.dropdown.contains(e.target)) {
                    if (e.target.hasAttribute('data-choice')) this._highlightChoice(e.target);
                }
            }
        }, {
            key: '_onPaste', value: function _onPaste(e) {
            ...
            key: '_removeItem', value: function _removeItem(item) {
                ...
                if (group && group.value) {
                    ...
                    (0, _utils.triggerEvent)(this.passedElement, 'removeItem', {id: id, value: value, label: label});
                }
                return this;
            }
        }, {
            ...
            key: '_clearChoices', value: function _clearChoices() {
                this.store.dispatch((0, _index3.clearChoices)());
            }
        }, {
            key: '_addGroup', value: function _addGroup(group, id) {
                var _this21 = this;
            ...
            key: '_setLoading', value: function _setLoading(isLoading) {
        ...
        return Choices;
    }();}),(function(module,exports,__webpack_require__){;(function(global){'use strict'
